...
本项目是 [Vite Microapp React Example](https://github.com/liuzane/microapp-react-vite-example) 的主应用，采用 MicroApp 框架聚合多个独立子应用（如订单管理、用户管理等）。主要职责：
...
```bash
# 1. 克隆仓库
git clone https://github.com/liuzane/microapp-react-vite-example.git
cd host
